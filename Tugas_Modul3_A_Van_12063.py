...
st.markdown("""
    <div class="center">
        <img src="https://media.tenor.com/1efpG-4R5sAAAAAi/monster-hunter.gif" alt="Welcome Image">
    </div>
""", unsafe_allow_html=True)
st.markdown("<h1 style ='text-align: center; color: #4CAF50'>Prediksi IPK - 12063<\h1>", unsafe_allow_html=True)
st.markdown("""<p style = 'text-align: center; color: #0073e6'> Aplikasi ini berguna untuk memprediksi IP berdasarkan nilai Matematika,
...
if uploaded_file is not None:
    ...
    if os.path.exists(model_path):
        ...
        mtk1 = st.sidebar.number_input("Nilai Matematika Semester 1.1", 68.0, 100.0)
        ...
        ind1 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 1.1", 64.0, 98.0)
        ind2 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 1.2", 62.0, 99.0)
        ind3 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 2.1", 68.0, 99.0)
        ind4 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 2.2", 68.0, 100.0)
